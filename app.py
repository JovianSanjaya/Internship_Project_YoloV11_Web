...
class Detection:
    def __init__(self):
        ...
        yolov8_model_path = r"C:\Internship Project YoloV11 Web\object_detection\best.pt"  # Update to your model path
        ...
        self.export_dir = r"C:\Internship Project YoloV11 Web\results"
